              ...
              <form method="POST" action="{{ url('/alternatif/store')}}" class="form-horizontal">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="nama" placeholder="Alternatif" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="jenis_tanaman" class="col-sm-2 col-form-label">C1</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="efek_Samping" placeholder="Nilai Kriteria (Efek Samping)" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="jenis_tanah" class="col-sm-2 col-form-label">C2</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="efektivitas" placeholder="Nilai Kriteria (Efektivitas)" required>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="dosis" placeholder="Nilai Kriteria (Dosis)" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="kadar_air" class="col-sm-2 col-form-label">C5</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="ketersediaan" placeholder="Nilai Kriteria (ketersediaan)" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
